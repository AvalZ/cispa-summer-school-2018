...
public final class j implements b {
    ...
    private static void a(StringBuilder stringBuilder, int i, int i2, String str) {
        if ((i & i2) == i2) {
    ...
    L_0x0009:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.view.menu.j.d(boolean):void");
    }
    ...
    public Drawable getIcon() {
        ...
        if (this.m != null) {
            ...
            drawable = android.support.v7.b.a.a.b(this.a.f(), this.n);
            this.n = 0;
            this.m = drawable;
        }
        return a(drawable);
