...
public abstract class s {
    ...
    void a(View view, ArrayList<View> arrayList, ArrayList<View> arrayList2, ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        v.a(view, new Runnable() {
            public void run() {
                for (int i = 0; i < size; i++) {
                    r.a((View) arrayList5.get(i), (String) arrayList6.get(i));
                    r.a((View) arrayList7.get(i), (String) arrayList4.get(i));
                }
            }
        });
    }
    ...
    void a(ViewGroup viewGroup, final ArrayList<View> arrayList, final Map<String, String> map) {
        v.a(viewGroup, new Runnable() {
            public void run() {
                ...
                for (int i = 0; i < size; i++) {
                    View view = (View) arrayList.get(i);
                    r.a(view, (String) map.get(r.k(view)));
                }
            }
        });
    }
            ...
            if (view2 instanceof ViewGroup) {
                ...
                if (!t.a(view2)) {
                    ...
                    for (int i = 0; i < childCount; i++) {
                        a((ArrayList) arrayList, view2.getChildAt(i));
                    }
                    return;
                }
            }
